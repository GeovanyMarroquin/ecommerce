...
<head>
    ...
    <link href="{{asset('main-template/assets/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('main-template/assets/vendor/bootstrap-icons/bootstrap-icons.css')}}" rel="stylesheet">
    <link href="{{asset('main-template/assets/vendor/aos/aos.css')}}" rel="stylesheet">
    <link href="{{asset('main-template/assets/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet">
    <link href="{{asset('main-template/assets/vendor/glightbox/css/glightbox.min.css')}}" rel="stylesheet">
    <link href="{{asset('main-template/assets/vendor/swiper/swiper-bundle.min.css')}}" rel="stylesheet">

    <!-- Main CSS File -->
    <link href="{{asset('main-template/assets/css/main.css')}}" rel="stylesheet">
    ...
    <div class="branding d-flex align-items-center">
        ...
        <div class="container position-relative d-flex align-items-center justify-content-between">
            <a href="index.html" class="logo d-flex align-items-center me-auto">
                ...
                <!-- <img src="{{ asset('main-template/assets/img/logo.png') }}" alt=""> -->
...
<main class="main">
    ...
    <section id="hero" class="hero section light-background">
        ...
        <img src="{{ asset('main-template/assets/img/hero-bg.jpg') }}" alt="" data-aos="fade-in">
        ...
        <div class="container">
            ...
            <div class="row gy-4 gx-5">
                ...
                <div class="col-lg-6 position-relative align-self-start" data-aos="fade-up" data-aos-delay="200">
                    <img src="{{ asset('main-template/assets/img/about.jpg') }}" class="img-fluid" alt="">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active show" id="departments-tab-1">
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center order-1 order-lg-2">
                                    <img src="{{ asset('main-template/assets/img/departments-1.jpg') }}" alt=""
                                         class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="departments-tab-2">
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center order-1 order-lg-2">
                                    <img src="{{ asset('main-template/assets/img/departments-2.jpg') }}" alt=""
                                         class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="departments-tab-3">
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center order-1 order-lg-2">
                                    <img src="{{ asset('main-template/assets/img/departments-3.jpg') }}" alt=""
                                         class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="departments-tab-4">
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center order-1 order-lg-2">
                                    <img src="{{ asset('main-template/assets/img/departments-4.jpg') }}" alt=""
                                         class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="departments-tab-5">
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center order-1 order-lg-2">
                                    <img src="{{ asset('main-template/assets/img/departments-5.jpg') }}" alt=""
                                         class="img-fluid">
                                </div>
                            </div>
                        </div>
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="team-member d-flex align-items-start">
                        <div class="pic"><img src="{{ asset('main-template/assets/img/doctors/doctors-1.jpg') }}"
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="team-member d-flex align-items-start">
                        <div class="pic"><img src="{{ asset('main-template/assets/img/doctors/doctors-2.jpg') }}"
                                              class="img-fluid" alt=""></div>
                        <div class="member-info">
                            <h4>Sarah Jhonson</h4>
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="team-member d-flex align-items-start">
                        <div class="pic"><img src="{{ asset('main-template/assets/img/doctors/doctors-3.jpg') }}"
                                              class="img-fluid" alt=""></div>
                        <div class="member-info">
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
                    <div class="team-member d-flex align-items-start">
                        <div class="pic"><img src="{{ asset('main-template/assets/img/doctors/doctors-4.jpg') }}"
                                              class="img-fluid" alt=""></div>
                        <div class="member-info">
                            <h4>Amanda Jepson</h4>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    <div class="d-flex">
                                        <img
                                            src="{{ asset('main-template/assets/img/testimonials/testimonials-1.jpg') }}"
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    <div class="d-flex">
                                        <img
                                            src="{{ asset('main-template/assets/img/testimonials/testimonials-2.jpg') }}"
                                            class="testimonial-img flex-shrink-0" alt="">
                                        <div>
                                            <h3>Sara Wilsson</h3>
                                            <h4>Designer</h4>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    <div class="d-flex">
                                        <img
                                            src="{{ asset('main-template/assets/img/testimonials/testimonials-3.jpg') }}"
                                            class="testimonial-img flex-shrink-0" alt="">
                                        <div>
                                            <h3>Jena Karlis</h3>
                                            <h4>Store Owner</h4>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    <div class="d-flex">
                                        <img
                                            src="{{ asset('main-template/assets/img/testimonials/testimonials-4.jpg') }}"
                                            class="testimonial-img flex-shrink-0" alt="">
                                        <div>
                                            <h3>Matt Brandon</h3>
                                            <h4>Freelancer</h4>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    <div class="d-flex">
                                        <img
                                            src="{{ asset('main-template/assets/img/testimonials/testimonials-5.jpg') }}"
                                            class="testimonial-img flex-shrink-0" alt="">
                                        <div>
                                            <h3>John Larson</h3>
                                            <h4>Entrepreneur</h4>
            ...
            <div class="row g-0">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="{{ asset('main-template/assets/img/gallery/gallery-1.jpg') }}" class="glightbox"
                           data-gallery="images-gallery">
                            <img src="{{ asset('main-template/assets/img/gallery/gallery-1.jpg') }}" alt=""
                                 class="img-fluid">
                        </a>
                    </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="{{ asset('main-template/assets/img/gallery/gallery-2.jpg') }}" class="glightbox"
                           data-gallery="images-gallery">
                            <img src="{{ asset('main-template/assets/img/gallery/gallery-2.jpg') }}" alt=""
                                 class="img-fluid">
                        </a>
                    </div>
                </div><!-- End Gallery Item -->
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="{{ asset('main-template/assets/img/gallery/gallery-3.jpg') }}" class="glightbox"
                           data-gallery="images-gallery">
                            <img src="{{ asset('main-template/assets/img/gallery/gallery-3.jpg') }}" alt=""
                                 class="img-fluid">
                        </a>
                    </div>
                </div><!-- End Gallery Item -->
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="{{ asset('main-template/assets/img/gallery/gallery-4.jpg') }}" class="glightbox"
                           data-gallery="images-gallery">
                            <img src="{{ asset('main-template/assets/img/gallery/gallery-4.jpg') }}" alt=""
                                 class="img-fluid">
                        </a>
                    </div>
                </div><!-- End Gallery Item -->
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="{{ asset('main-template/assets/img/gallery/gallery-5.jpg') }}" class="glightbox"
                           data-gallery="images-gallery">
                            <img src="{{ asset('main-template/assets/img/gallery/gallery-5.jpg') }}" alt=""
                                 class="img-fluid">
                        </a>
                    </div>
                </div><!-- End Gallery Item -->
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="{{ asset('main-template/assets/img/gallery/gallery-6.jpg') }}" class="glightbox"
                           data-gallery="images-gallery">
                            <img src="{{ asset('main-template/assets/img/gallery/gallery-6.jpg') }}" alt=""
                                 class="img-fluid">
                        </a>
                    </div>
                </div><!-- End Gallery Item -->
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="{{ asset('main-template/assets/img/gallery/gallery-7.jpg') }}" class="glightbox"
                           data-gallery="images-gallery">
                            <img src="{{ asset('main-template/assets/img/gallery/gallery-7.jpg') }}" alt=""
                                 class="img-fluid">
                        </a>
                    </div>
                </div><!-- End Gallery Item -->
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="{{ asset('main-template/assets/img/gallery/gallery-8.jpg') }}" class="glightbox"
                           data-gallery="images-gallery">
                            <img src="{{ asset('main-template/assets/img/gallery/gallery-8.jpg') }}" alt=""
                                 class="img-fluid">
                        </a>
                    </div>
                </div><!-- End Gallery Item -->
    ...
    <div class="container copyright text-center mt-4">
        ...
        <div class="credits">
            ...
            Designed by <a href="https://bootstrapmade.com/">BootstrapMade</a> Distributed by <a
                href=“https://themewagon.com></a>ThemeWagon
        </div>
    </div>
...
<script src="{{asset('main-template/assets/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
<script src="{{asset('main-template/assets/vendor/php-email-form/validate.js')}}"></script>
<script src="{{asset('main-template/assets/vendor/aos/aos.js')}}"></script>
<script src="{{asset('main-template/assets/vendor/glightbox/js/glightbox.min.js')}}"></script>
<script src="{{asset('main-template/assets/vendor/purecounter/purecounter_vanilla.js')}}"></script>
<script src="{{asset('main-template/assets/vendor/swiper/swiper-bundle.min.js')}}"></script>
<!-- Main JS File -->
<script src="{{asset('main-template/assets/js/main.js')}}"></script>
